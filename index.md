...
* [Safe Superintelligence](companies/ssi.md) - The frontier research lab founded in June 2024 by Ilya Sutskever, Daniel Gross and Daniel Levy, with no product line and no revenue, valued at 30 billion dollars by March 2025 and paired with Nvidia on compute from July 2026.
...
* [David Lee](founders/david-lee.md) - Investor who joined Google's new business team in 2003, ran SV Angel as managing partner until an abrupt departure in 2015, co-founded Refactor Capital in 2016, and has led Samsung Next since 2021.
...
* [Don Valentine](founders/don-valentine.md) - Founder of Sequoia Capital in 1972 and the investor behind Sequoia's first positions in Atari and Apple; previously a sales and marketing executive at Raytheon, National Semiconductor and Fairchild Semiconductor; died in 2019.
* [Durk Kingma](founders/durk-kingma.md) - Dutch machine learning researcher and OpenAI co-founder, co-author of the Adam optimizer and the variational autoencoder, now a researcher at Anthropic in Amsterdam.
...
* [Nat Friedman](founders/nat-friedman.md) - Software executive and investor who co-founded Ximian and Xamarin, ran GitHub from 2018 to 2021, co-founded AI Grant and the NFDG investment partnership with Daniel Gross, and since 2025 leads product at Meta Superintelligence Labs.
...
* [Ron Conway](founders/ron-conway.md) - San Francisco investor known as a super angel, operator of the Angel Investors funds that were early in Google and PayPal, and co-founder and managing partner of SV Angel, whose 2022 growth fund is reported to hold positions in OpenAI and Anthropic.
...
* [Yuri Milner](founders/yuri-milner.md) - Soviet-born Israeli physicist turned investor, founder of the Digital Sky Technologies line and of DST Global, co-founder and former chairperson of Mail.Ru Group, and a citizen of Israel since 1999 who renounced his Russian citizenship in 2022.

# Investors

* [a16z](investors/a16z.md) - Andreessen Horowitz, the Menlo Park venture firm founded in 2009, a named investor in Safe Superintelligence, Replit, Cursor, ElevenLabs, Mistral AI, World Labs and xAI, and the largest venture capital firm by assets under management.
* [DST Global](investors/dst-global.md) - The late-stage fund founded in 2009 as a spinoff of Digital Sky Technologies, a participant in the Anthropic Series H of 2026 and one of the five investors named in the Safe Superintelligence round.
* [NFDG](investors/nfdg.md) - The AI-focused investment partnership of Nat Friedman and Daniel Gross, founded in 2023, one of five named investors in the reported 1B dollar round in Safe Superintelligence, and the operator of the Andromeda Cluster supercomputer for its portfolio.
* [Sequoia Capital](investors/sequoia-capital.md) - The Menlo Park venture firm founded in 1972, the first outside investor in OpenAI in 2021, a co-lead of the Anthropic Series H in 2026, and an investor in Safe Superintelligence and xAI.
* [SV Angel](investors/sv-angel.md) - The San Francisco seed firm founded in 2009 by Ron Conway and David Lee, a participant in the Safe Superintelligence round and in the ElevenLabs Series A, and the firm whose growth fund is reported to hold positions in OpenAI and Anthropic.
...
* [Computer use](ai-use-cases/computer-use.md) - The use case in which a model drives a graphical interface - a browser or a desktop - by perceiving the screen and generating mouse and keyboard actions, rather than through an API; the capability Claude implemented with its computer-use tool and OpenAI with Operator.
* [Customer service automation](ai-use-cases/customer-support.md) - AI acquiring, resolving and escalating the work of a customer-service operation - live chat, email, voice and SMS triage and resolution - of which the measurable cases are Decagon's $4.5B valuation and the AI agents running in Intercom's product.
* [Enterprise knowledge and productivity](ai-use-cases/enterprise-knowledge.md) - Using AI on the knowledge a business already holds - internal documents, mail, slides, spreadsheets and web apps - for retrieval, summarisation and document work; the terrain where Copilot, Gemini in the Workspace, NotebookLM/Gemini Notebook and internal-knowledge search compete head to head.
* [No-code application building](ai-use-cases/no-code-app-building.md) - Turning natural-language prompts into deployed web applications without writing code, addressed to non-developers; the platform that opened the market is Replit, and the agentic-tooling frontier crossed into it as vendors added prompt-to-app agents.
* [Scientific research](ai-use-cases/scientific-research.md) - AI used to advance scientific discovery, analysis and knowledge synthesis - from protein-structure prediction that won a Nobel Prize to research agents that browse the literature autonomously and return citations.
...
Generated by `_tools/build-index.py` on 2026-09-15.
