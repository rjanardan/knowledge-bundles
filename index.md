...
A knowledge bundle in Google's Open Knowledge Format v0.2. It is a graph first: 36 concepts carrying 353 typed edges, with `_tools/okf-check.py` for conformance and `_tools/build-index.py` for these listings.
