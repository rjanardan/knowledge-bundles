---
type: Timeline
title: Timeline of leading AI companies, people and turning points
description: A derived, left-to-right chronology of every company and person in this bundle, from 1960 to September 2026, kept as a single view that is updated whenever a dated fact lands.
resource: /index.md
tags:
  - timeline
  - chronology
...
relations:
  - { type: related-to, target: /companies/openai.md }
  - { type: related-to, target: /companies/anthropic.md }
  - { type: related-to, target: /companies/google.md }
  - { type: related-to, target: /companies/google-deepmind.md }
  - { type: related-to, target: /companies/replit.md }
  - { type: related-to, target: /founders/sam-altman.md }
  - { type: related-to, target: /founders/dario-amodei.md }
  - { type: related-to, target: /founders/amjad-masad.md }
  - { type: related-to, target: /founders/demis-hassabis.md }
  - { type: related-to, target: /founders/ilya-sutskever.md }
  - { type: related-to, target: /founders/greg-brockman.md }
  - { type: related-to, target: /founders/andrej-karpathy.md }
  - { type: related-to, target: /founders/john-schulman.md }
  - { type: related-to, target: /founders/durk-kingma.md }
  - { type: related-to, target: /founders/trevor-blackwell.md }
  - { type: related-to, target: /founders/vicki-cheung.md }
  - { type: related-to, target: /founders/pamela-vagata.md }
  - { type: related-to, target: /founders/wojciech-zaremba.md }
  - { type: related-to, target: /founders/elon-musk.md }
  - { type: related-to, target: /founders/mira-murati.md }
  - { type: related-to, target: /founders/yann-lecun.md }
  ...
  - { type: related-to, target: /founders/nat-friedman.md }
  - { type: related-to, target: /founders/daniel-gross.md }
  - { type: related-to, target: /founders/yuri-milner.md }
...
sources:
  ...
  - id: wiki-altman
    ...
    author: wiki:en
  - id: wiki-dario
    resource: https://en.wikipedia.org/wiki/Dario_Amodei
    title: 'Wikipedia, "Dario Amodei"'
    author: wiki:en
  - id: wiki-amjad
    resource: https://en.wikipedia.org/wiki/Amjad_Masad
    title: 'Wikipedia, "Amjad Masad"'
    author: wiki:en
  - id: wiki-sutskever
    resource: https://en.wikipedia.org/wiki/Ilya_Sutskever
    title: 'Wikipedia, "Ilya Sutskever"'
    author: wiki:en
  - id: wiki-brockman
    resource: https://en.wikipedia.org/wiki/Greg_Brockman
    title: 'Wikipedia, "Greg Brockman"'
    author: wiki:en
  - id: wiki-karpathy
    resource: https://en.wikipedia.org/wiki/Andrej_Karpathy
  ...
  - id: wiki-kingma
    ...
    author: wiki:en
  - id: wiki-blackwell
    resource: https://en.wikipedia.org/wiki/Trevor_Blackwell
    title: 'Wikipedia, "Trevor Blackwell"'
    author: wiki:en
  - id: wiki-zaremba
    resource: https://en.wikipedia.org/wiki/Wojciech_Zaremba
    title: 'Wikipedia, "Wojciech Zaremba"'
    author: wiki:en
  - id: wiki-murati
    resource: https://en.wikipedia.org/wiki/Mira_Murati
    title: 'Wikipedia, "Mira Murati"'
    author: wiki:en
  - id: wiki-lecun
    resource: https://en.wikipedia.org/wiki/Yann_LeCun
    title: 'Wikipedia, "Yann LeCun"'
    author: wiki:en
  - id: wiki-musk
    resource: https://en.wikipedia.org/wiki/Elon_Musk
    title: 'Wikipedia, "Elon Musk"'
    author: wiki:en
  - id: eureka
    resource: https://eurekalabs.ai/
    title: 'Eureka Labs, "Introducing Eureka Labs", 16 July 2024'
    author: org:eureka-labs
  - id: tml-news
    resource: https://thinkingmachines.ai/news
    title: 'Thinking Machines Lab, news index'
    author: org:thinking-machines-lab
  - id: pebblebed
    resource: https://pebblebed.com/
    title: 'Pebblebed, firm site'
    author: org:pebblebed
  - id: vcsheet
    resource: https://www.vcsheet.com/who/pamela-vagata
    title: 'VCSheet, Pamela Vagata, secondary profile'
    author: org:vcsheet
  - id: foundation-news
    resource: https://blockchain.news/news/openai-foundation-commits-1b-annually-healthcare-ai-safety
    title: 'OpenAI Foundation commits $1B annually, trade report, April 2026'
    author: org:blockchain-news
  ...
  - id: wiki-gross
    ...
    author: wiki:en
  - id: wiki-milner
    resource: https://en.wikipedia.org/wiki/Yuri_Milner
    title: 'Wikipedia, "Yuri Milner"'
    author: wiki:en
  - id: wiki-dv
    resource: https://en.wikipedia.org/wiki/Don_Valentine
    title: 'Wikipedia, "Don Valentine"'
    author: wiki:en
  - id: wiki-conway
    resource: https://en.wikipedia.org/wiki/Ron_Conway
    title: 'Wikipedia, "Ron Conway"'
    author: wiki:en
  - id: wiki-lee
    resource: https://en.wikipedia.org/wiki/David_Lee_(investor)
    title: 'Wikipedia, "David Lee (investor)"'
    author: wiki:en
  - id: wiki-msl
    ...
    author: wiki:en
  - id: aigrant
    resource: https://new.aigrant.org/
    title: 'AI Grant, programme site, observed 11 September 2026'
    author: org:ai-grant
  - id: samsung-next
    resource: https://www.samsungnext.com/team
    title: 'Samsung Next, team page, observed 11 September 2026'
    author: org:samsung-next
  - id: tc-refactor
    resource: https://techcrunch.com/2016/03/22/david-lee-is-back-with-a-new-fund-refactor-capital/
    title: 'TechCrunch, "David Lee is back with a new fund: Refactor Capital", 22 March 2016'
    author: org:techcrunch
---
...
timeline
    ...
    section 1960 to 1998
        ...
        1961 : Milner born in Moscow
        1971 : Musk born
        1972 : Sequoia Capital founded by Valentine
        1991 : Gross born in Jerusalem
        1998 : Google founded
    section 1999 to 2010
        1999 : Friedman co-founds Ximian
        2001 : Milner becomes Mail.Ru chief executive
        2003 : Lee joins Google
        2009 : Andreessen Horowitz founded
        2009 : DST Global and SV Angel founded
        2010 : DeepMind founded in London
    section 2011 to 2016
        2011 : Friedman founds Xamarin
        2011 : The Start fund links DST Global and SV Angel
        2013 : Apple acquires Cue
        2014 : Google confirms the DeepMind acquisition
        2015 : Lee leaves SV Angel
        2016 : Replit founded
    section 2017 to 2021
        2017 : Friedman and Gross create AI Grant
        2018 : Musk resigns from the OpenAI board
        2019 : Valentine dies
        2021 : Anthropic founded
        2021 : Sequoia partners with OpenAI
        2021 : Lee takes over Samsung Next
    ...
    section 2025 to 2026
        ...
        2025 : Friedman and Gross join Meta
